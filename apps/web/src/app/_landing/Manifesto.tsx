...
const TEXT =
  "Your work deserves more than a link in a bio. ACEapp turns projects into a portfolio that feels designed, loads instantly, and shows up everywhere people look for you.";
