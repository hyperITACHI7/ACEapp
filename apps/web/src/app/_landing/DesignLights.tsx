...
export default function DesignLights() {
  ...
  useEffect(() => {
    scrollDataRef.current.lastY = window.scrollY;
    scrollDataRef.current.lastTime = performance.now();
    ...
    const animate = () => {
      ...
      const velocityDiff =
        scrollDataRef.current.targetVelocity - scrollDataRef.current.currentVelocity;
