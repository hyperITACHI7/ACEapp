...
export const sections: Section[] = [
  ...
  },
  {
    ...
    copy: "Describe the vibe and Folio drafts your copy, suggests layouts, and rewrites case studies in your voice. You stay the artist; the busywork disappears.",
